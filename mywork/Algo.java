...
public class Algo extends JFrame {
	...
	public Algo() {
		...
		label.setIcon(new ImageIcon(Algo.class.getResource("/images/simulator.png")));
		label.setBackground(Color.WHITE);
		label.setForeground(Color.WHITE);
		label.setHorizontalAlignment(SwingConstants.CENTER);
		
		JLabel label_1 = new JLabel();
		label_1.setIcon(new ImageIcon(Algo.class.getResource("/images/algorithm.png")));
		...
		label_2.setIcon(new ImageIcon(Algo.class.getResource("/images/home.png")));
